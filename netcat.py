...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent('''Example:
                               ...
                               echo 'ABC' | ./netcat.py -t 1992.168.0.1 -p 135 # echo text to server port 135
...
'''))
    ...
    parser.add_argument('-t','--target',default='192.168.0.101',help='specified IP')
